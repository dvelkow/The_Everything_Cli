...
This is the foundation. The building blocks are in place — the shell, the prompt, the command router. What gets built on top is where it gets interesting:
...
- **Calendar glances** — see what's next without opening anything
- **Pomodoro timer** — focus sessions built right in
